             ...
             <Loader loading={this.state.loading}/>
                ...
                <LinearGradient style={{height: 50,}} colors={Colorss.basecolor}>
                    <View style={{justifyContent:'space-between',width:'100%',height:50,alignItems:'center' ,paddingHorizontal:20,flexDirection:'row'}}>
                     ...
                     <TouchableOpacity onPress={()=>{this.backpress()}} style={{alignItems:'center',justifyContent:'center',width:'10%'}}>
                      <Image style={{width:20,height:20,resizeMode:'center',}} source={require('./icons/backw.png')}></Image>
                      </TouchableOpacity>
                      {this.state.pagename==1 &&
                        <Text style={{alignSelf:'center',fontSize:14,fontWeight:'bold',color:Colorss.whiteColor}}>{Lang_chg.titleprivacy[config.language]}</Text>
                       }
                      {this.state.pagename==0 &&
                       <Text style={{alignSelf:'center',fontSize:14,fontWeight:'bold',color:Colorss.whiteColor}}>{Lang_chg.titleabout[config.language]}</Text>
                      }
                     {this.state.pagename==2 &&
                       <Text style={{alignSelf:'center',fontSize:14,fontWeight:'bold',color:Colorss.whiteColor}}>{Lang_chg.titleTermscondition[config.language]}</Text>
                      }

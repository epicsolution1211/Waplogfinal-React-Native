...
export default class Inbox extends Component {
    ...
    renderitem = ({ item }) => {
        ...
        return (
            ...
            <TouchableOpacity activeOpacity={0.9} onPress={()=>{this.checkfreindstatus(item)}}>
                <View style={{ backgroundColor: 'white', borderRadius: 12,marginBottom:5, paddingHorizontal: 10,paddingVertical:10, flexDirection: 'row', width: '100%', borderWidth:0.5,borderColor:'#cfcfcf' }}>
                   <View style={{ width:'15%',alignSelf: 'center',alignItems:'center',justifyContent:'center' }}>
                    {item.images==undefined?
                        <ImageBackground imageStyle={{ borderRadius: 20 }} style={{ width: 40, height: 40, resizeMode: 'cover' }} source={require('./icons/new.png')}>
                        </ImageBackground>:
                               item.images=='NA'?
                               <ImageBackground imageStyle={{ borderRadius: 20 }} style={{ width: 40, height: 40, resizeMode: 'cover' }} source={require('./icons/new.png')}>
                        </ImageBackground>:
                        ...
                        <ImageBackground imageStyle={{ borderRadius: 20 }} style={{ width: 40, height: 40, resizeMode: 'cover' }} source={{uri:item.images}}>
                        </ImageBackground>
                            }
                    ...
                    <View style={{ marginLeft:10,width:'65%', alignSelf: 'center', }}>
                           <Text style={{ fontSize: 18,fontFamily:'Piazzolla-Bold' }}>{item.name}</Text>
                           <Text style={{ fontSize: 12,fontFamily:'Piazzolla-Regular' }}>{item.message}</Text>
                        </View>
                        <View style={{width:'20%', alignSelf: 'center',alignItems:'flex-end',right:19 }}>
                               {item.count!=0 && <View style={{alignItems:'center',justifyContent:'center',backgroundColor:'green',width:24,height:24,borderRadius:12}}>
                                    <Text style={{ color:'white',fontSize:12,fontFamily:'Piazzolla-Regular'}}>{item.count}</Text>
                               </View>}
                              
                        <Text style={{ fontSize: 13,fontFamily:'Piazzolla-Regular' }}>{item.time}</Text>
    ...
    render() {
        return (
            <View style={{backgroundColor:Colorss.whiteColor,flex:1}}>
                <ScrollView> 
                <View style={{backgroundColor:Colorss.theme1, flexDirection: 'row', width:'100%',paddingVertical:15 }}>
                        <TouchableOpacity onPress={()=>{this.props.navigation.goBack()}} style={{width:'10%',alignItems:'center',justifyContent:'center'}}>
                        <Image style={{resizeMode:'contain', width: 20, height: 20}} source={require('./icons/backw.png')}></Image>
                        </TouchableOpacity>
                        <View style={{width:'80%',alignSelf:'center'}}> 
                        <Text style={{ fontSize: 18, fontFamily:'Piazzolla-Bold',textAlign:'center',color:'#FFFFFF' }}>{Lang_chg.tittleinbox[config.language]}</Text>
                        </View>
                ...
                <Text style={{alignSelf:'center',fontSize:18,fontFamily:'Piazzolla-Bold',color:Colorss.whiteColor }}>Inbox</Text>

            ...
            <View>
                <ImageBackground source={require('./icons/play_status.png')} style={{width:'100%',height:'100%'}}>
                      <View style={{width:'100%',paddingHorizontal:10}}>
                          ...
                          <TouchableOpacity  onPress={() => {this.backpress()}} style={{marginTop:5,orderColor:'red',borderWidth:0,width:35,height:35,alignItems:'center',justifyContent:'center'}}>
                          <Image style={{ width:20,height:20,resizeMode:'contain'}} source={require('./icons/add_cros.png')}></Image>
                         </TouchableOpacity>
                         <View style={{flexDirection:'row' ,marginLeft:15,alignItems:'center' ,marginTop:8}}>
                                ...
                                <View style={{marginLeft:10}}>
                                    ...
                                    <Text style={{fontSize:10,fontFamily:'Piazzolla-SemiBold',color:Colorss.whiteColor}}>3d reamaining</Text>
                                </View>
                         </View>
                         <TouchableOpacity style={{alignItems:'center',justifyContent:'center',marginTop:5, borderWidth:0, position:'absolute',right:0, width:35,height:35}}>
                   ...
                   <View style={{  justifyContent:'space-between',flexDirection:'row', }}>
                            ...
                            <View style={{ marginLeft:15,flexDirection: 'row' }}>
                                 <Text></Text>
                                <Image style={{width:40,height:40,resizeMode:'contain'}} source={require('./icons/other_story.png')}></Image>
                            </View>

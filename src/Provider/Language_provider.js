...
class Language_provider {
  ...
  updatelanguage = async(language_id) => {
    console.log('editimagefunction')
    let userdata=await localStorage.getItemObject('user_arr')
    if(userdata!=null)
    {
    let user_id=userdata.user_id
   let url = config.baseURL+"change_language.php?user_id="+user_id+"&language_id="+language_id
     console.log('url',url)
...
language_get=async()=>{
   ...
   if(item!=null)
      {
        ...
        if(userdata!=null)
        {
          config.language=userdata.language_id;
        }
 ...
 language_set=(value)=>{
    ...
    boostbuynow=['BUY NOW','COMPRA AHORA','COMPRE AGORA'];
    boosttitle=['Boost Yourself','Impulse usted mismo','Impulsione-se'];
    boost_key=['Boosts','Impulsos','Boosts'] ;
    your_boost=['Your Boost','Tu impulso','Seu Boost']
...
Coin=['COIN','MONEDA','MOEDA'];
   ...
   //------------social login page----------------//
    ...
    Bycontinueagree=['By Continuing, agree to our','Al continuar, acepta nuestra','Ao continuar, concorde com nossos'] 
    termscondition=['Terms & Conditions','Términos y condiciones','termos e Condições']
    and=['and','y','e']
...
//-------------------------login page start------------------------------//
 ...
 //----------------------------Enter birthday-----------------------//
 titlebirthday=['When Is Your Birthday','Tu Fecha de Nacimiento','Quando é seu aniversário']
...
//-----------------------------enter gender page-----------------------------//
titlegender=["I'm a..",'Soy','Eu sou um']
...
Malegender=['Male','Hombres','Masculina']
Femalegender=['Female','Mujeres','Fêmea']
Bothgender=['Both','Ambos','Ambas']
...
//-----------------------------welcome page----------------------------//
titleWelcome=['Welcome','Bienvenid@','Bem-vinda']
...
storyprofile=['Stories','Estados','Histórias']
likeprofile=['Liked','Gustó','Gostou']
friendprofile=['Friends','Amigos','Amiga']
...
//--------------------------setting page----------------------------------//
titlesetting=['Settings','Ajuste','Configuração']
...
privacy=['Privacy Policy','Políticas de privacidad','Políticas de privacidade']
...
friendhading=['Friends','Amigos','Amiga']
titlegenderbasic=["I'm a..",'Soy','Eu sou um']
Malegender=['Male','Hombres','Masculina']
Femalegender=['Female','Mujeres','Fêmea']
...
titleprivacy=['Privacy Policy','Políticas de privacidad','Políticas de privacidade']
titleabout=['About','Escribe algo sobre ti','Sobre']
//---------------------------share app page---------------------------//
...
year=['year','año','ano']
Malefilter=['Male','Hombres','Masculina']
Femalefilter=['Female','Mujeres','Fêmea']
Bothfilter=['Both','Ambos','Ambas']
...
Addfriedbtnhomedetaile=['Add as friend','Agregar como amigo','Adicionar como amigo']
...
alredy_boost=['already boost your porfile','ya impulsa tu perfil','já impulsione seu perfil']
...
response_msg = ['Response', 'Respuesta','Resposta'];
  ...
  OFF_laung=['OFF','APAGADO','DESLIGADA']
  accept_btn_laung=['Please accept terms & conditions and privacy policy','Acepta los términos, condiciones y política de privacidad.','Aceite os termos, condições e política de privacidade']
}

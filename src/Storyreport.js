            ...
            let userdata=await localStorage.getItemObject('user_arr')
             ...
             let user_id=userdata.user_id
              if(this.state.isConnected==true)
                 { this.setState({loading:true});
                  let url= config.baseURL+"story_report_add.php?user_id="+user_id+'&story_id='+this.state.story_id+'&feedback='+this.state.feedback;
            ...
            <TouchableOpacity activeOpacity={1} onPress={()=>{Keyboard.dismiss()}}>
                <Loader loading={this.state.loading}/>
                    <View style={{ width: '100%', height: 60, justifyContent: 'center' }}>
                        ...
                        <Text style={{ alignSelf: 'center', fontSize: 18, fontFamily:'Piazzolla-Bold', color: Colorss.blackColor }}>Story Report</Text>
                    ...
                    <LinearGradient style={{ alignItems: 'center', justifyContent: 'center',borderRadius: 10, height: 50}} colors={Colorss.basecolor}>
                            <TouchableOpacity onPress={()=>{this.Reportstory()}}style={{width:'100%', alignItems: 'center', justifyContent: 'center',borderRadius: 10, height: 50 }}>
